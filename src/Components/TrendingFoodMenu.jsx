...
const TrendingFoodMenu = () => {
  return (
    <div className="pt-[114px] px-[20px] pb-[20px]">
      <div className="max-w-[1290px] w-[100%] mx-auto">
        ...
        <div className="grid grid-cols-2 max-[680px]:p-[15px]  max-[1230px]:grid-cols-1 border-dotted border-[1px] border-[#5C5C5B] rounded-[13px] mt-[30.09px] pb-[61px]">
...
export default TrendingFoodMenu;
