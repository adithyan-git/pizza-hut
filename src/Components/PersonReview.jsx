...
const PersonReview = () => {
  return (
    <div className="pt-[87px] pb-[120px]">
      <div className="max-w-[1290px] w-[100%] h-fit  max-[998px]:flex-col mx-auto flex  gap-[54px]">
        ...
        <div className="flex flex-col justify-center ">
          <div className="flex flex-col items-center h-fit">
            <p className="font-[Oswald] text-center font-[600] text-[29px] text-[#212121] capitalize">
              Piter Bowman
            </p>
            <p className="text-center font-[Oswald] font-[600] text-[20px] text-[#FFC222] capitalize mt-[6.33px]">
              Business CEO & co founder
            </p>
            <p className="max-w-[719.5977783203125px] w-[100%] font-[Oswald] font-[500] text-[34px]  max-[1197px]:text-[20px] text-[#212121] mt-[28.39px] text-center">
