        ...
        <div className=" flex flex-col  col-span-7 max-lg:col-span-12 ">
          <div className="w-fit px-[10px] max-lg:w-[100%]">
            <div className="w-fit max-lg:w-[100%] max-lg:flex  max-lg:flex-col max-lg:items-center max-lg:pt-[20px]">
              ...
              <h6 className=" max-sm:text-[30px] font-[Oswald] font-[700] text-[60px] text-[#212121] max-w-[580.1448364257812px] w-[100%] capitalize max-lg:text-center">
                the best delicious food made from us...
              </h6>
              <p className="max-w-[636.9617919921875px]  w-[100%] text-[17px] text-[#5C5C5B] font-[400] font-[Oswald] mt-[29.5px] max-lg:text-center">
            ...
            <div className="grid max-xl:mx-auto  max-sm:border-t-0   max-md:grid-cols-2  max-sm:grid-cols-1 grid-cols-3   border-t-[1px] border-[#D9D9D9] mt-[40.5px]  w-fit">
              <div className=" pt-[39.3px] pl-[30px] border-r-[1px] border-[#D9D9D9]  max-sm:border-r-0 pr-[80.62px] relative before:content-['0'] before:absolute before:font-[Oswald] before:font-[700] before:text-[90px] before:text-[#D9D9D9] before:left-0 before:top-0 before:z-[-1]">
                <p className="font-[Oswald] font-[500] text-[18px] text-[#212121] capitalize">
                  Satsified Clients
                </p>
            ...
            <div className="flex flex-wrap gap-[20px] max-sm:justify-center justify-between items-center mt-[50px]">
              <div>
